...
<head>
    ...
    <title>OnlineSportsClothes - Dashboard</title>
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="../Admin/CrearProductos.php">Crear Productos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="../Tienda.php">Ver Catalogo</a>
                    </li>
                </ul>
            </div>
        </div>
